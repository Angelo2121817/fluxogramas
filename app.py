...
st.caption("Sistema de Engenharia de Processos v6.5")import streamlit as st
import requests
import json
import re
import graphviz as graphviz_lib
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        if inicio != -1:
                            ...
                            # CORREÇÃO AQUI: Usando aspas triplas para remover as crases com segurança
...
st.caption("Sistema de Engenharia de Processos v6.4")import streamlit as st
import requests
import json
import re
import graphviz as graphviz_lib
